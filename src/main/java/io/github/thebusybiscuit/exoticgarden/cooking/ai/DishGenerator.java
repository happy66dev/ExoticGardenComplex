...
public class DishGenerator {
    ...
    public static String[] buildPrompt(
        ...
        String systemPrompt = "你是一个 Minecraft 烹饪游戏的菜肴生成器。\n\n"
            + "输入 JSON 字段说明:\n"
            + "- ingredients: [{name:\"食材名\",state:\"完整/切片/切丁/酱汁\",doneness:熟度百分比(100=完美,可超100),charLevel:\"NONE/LIGHT/MEDIUM/HEAVY/SEVERE\",weight:克,foodPoints:饱食度,saturation:饱和度,hint(可选):该食材的特殊属性或用途}]\n"
            + "- seasonings: [{name:\"调料名\",progress:渗入度百分比(0-200,100=完美),mlAmount:液体毫升量,hint(可选):该调料的特殊属性或用途}]\n"
            + "- fuelEffects: [\"燃料风味\"]\n"
