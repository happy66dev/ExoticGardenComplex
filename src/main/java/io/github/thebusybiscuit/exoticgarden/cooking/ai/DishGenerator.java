...
public class DishGenerator {
    ...
    public static String[] buildPrompt(
        ...
        String systemPrompt = "你是一个 Minecraft 烹饪游戏的菜肴生成器。\n"
            ...
            + "  quality字段格式: [品质颜色]品质字 §7([品质颜色]分数§7/§e100分§r) 全部使用§符号不使用&\n"
            + "  示例: §6完美 §7(§692§7/§e100分§r)  §7普通 §7(§750§7/§e100分§r)\n"
            ...
            + "\"servings\":份数整数(缺省1),"
            + "\"quality\":\"品质带颜色和分数格式字符串(缺省'§7普通 §7(§750§7/§e100分§r)')\","
            + "\"qualityScore\":细化品质分数整数0~100(缺省50),"
            + "\"hunger\":饱食度整数(缺省0),"
